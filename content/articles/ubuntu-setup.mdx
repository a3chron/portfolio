...
description: Some Ubuntu >=24.04 / Gnome customizations for a catppuccin look, aestethics (and efficiency?)
topic: Customization
date: "2025-04-21"
published: true
---
...
Basically my call on "How to make Gnome look good"™.
...
If you like others more, you can use these too, [Papirus](https://www.gnome-look.org/p/1166289/) for example is a quite common one.

We will use [Flat-Remix](https://www.gnome-look.org/p/1214931) here.

After downloading, you should have `01-Flat-Remix-GTK-Blue-20240730.tar.xz` (or some other icon theme) in your Downloads.
...
If you want to try out several starship prompts, or switch between them (for example based on your wallpaper)
make sure to try out [stellar](github.com/a3chron/stellar), a starship config manager.
...
Otherwise, I'll be updating this as always when (/if) I'll finish it.


## Custom window close buttons

For this one you'll need to be just a little bit more tech-savy.  
...
(probably somewhere at `~/.themes/xy)
...
> 
> In the worst case, all that can happen is, that you have to reinstall the whole theme.
> Don't edit your system `gtk.css` (if you don't know what your doing), but only the one of Themes you downloaded.

To apply these styles to Flathub apps too, you'll need to give all apps access to these directories:
