...
To customize your prompt, check out the [Starship Config](https://starship.rs/config/) information.
...
For the (as I am writing) latest v3 configuration, 
there are several distinct themes you can use, 
like the shown blue one, a red one, or a green, one (more are probably to come).

Check out the [starship-theme-switcher](/projects/starship-switcher) to get all my latest configs & themes.