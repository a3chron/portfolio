...
but also good to add some helpful information, for example the current git branch, Go, Node or Python versions, and much more...
...
As the Installation Guide is quite good, I will only mention the guides for Linux and MacOS.

For any other installation options, or shells, please check the [Starship Installation Guide](https://starship.rs/guide/#%F0%9F%9A%80-installation)
...
You can now customize your prompt, with all the options at [Starship Config](https://starship.rs/config/).

the Starship configuration is done it the following file (you may need to create it first): 

`~/.config/starship.toml`

If you want a quick setup, you can just paste one of my configs below in there, 
or even better, try out [stellar](https://github.com/a3chron/stellar), a cli tool to
get and switch between starship configs / themes quickyl.  
You can view all of the communities configs on the [stellar-hub](https://stellar-hub.vercel.app), search for one you like, 
and apply with stellar.

# My Starship Configuration

Here you can copy my starship configs if you like one of them. Altough I would suggest using stellar ;)

> [!IMPORTANT] stellar - starhsip theme manager
> I made [stellar](https://stellar-hub.vercel.app), a starship theme manager & switcher,  
> you can search for starship themes there / get my themes right from there, the setup is very quick n simple :)
> 
> Feel free to upload your own starship theme for other people to use to stellar :)
...
For the (as I was writing) latest v3 configuration, 
there are several distinct themes you can use, 
like the shown blue one, a red one, or a green one (more are probably to come).

Check out my [stellar profile](https://stellar-hub.vercel.app/a3chron) for the latest versions.