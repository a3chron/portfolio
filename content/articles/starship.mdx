...
If you want a quick setup, you can just paste one of my configs in there.
...
Feel free to check out my [nix-config](https://github.com/a3chron/nix-config/tree/main/home/starship-themes) for my latest starship themes.

# Small Extra

With the [starship-theme-switcher](/projects/nix-starship-theme-switch) you can easily switch between several starship themes