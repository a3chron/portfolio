---
title: stellar
description: Beatifule starship themes, one command away
repo: stellar
...
Getting good starship configs so far was mostly random, from someones github dotfiles, searching for something entirely else...  
