---
title: stellar
description: Beautiful starship themes, one command away (starship theme switcher & hub)
repo: stellar
url: https://stellar.a3chron.dev
date: "2026-02-08"
published: true
active: true
...
The easiest way to contribute to stellar is to [upload you own starship config](https://stellar.a3chron.dev/upload) for other to use.
