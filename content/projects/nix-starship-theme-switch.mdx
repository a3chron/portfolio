...
> [WARNING]
> This is by now a little deprecated, still useable, bot for anyone 
> Wanting more features, and a better experience, less setup etc., check out stellar.
> You can switch between local configs, as well as easily install community themes :)

-> [stellar project](/projects/stellar)  
-> [stellar repo](https://github.com/a3chron/stellar)  
-> [stellar hub (community starship configs)](https://stellar-hub.vercel.app)  
